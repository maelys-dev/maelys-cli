...
v0.2.7 (`docs/conventions.md` there is normative).
...
3. Tag the merge commit: `git tag -s vX.Y.Z -m "maelys-cli X.Y.Z"`, then
...
- `packaging/homebrew/maelys-cli.rb.in`: placeholders `@URL@`, `@VERSION@`,
