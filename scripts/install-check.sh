...
cmp share/agents/LICENSE "$root/usr/share/maelys-cli/agents/LICENSE"
grep -q 'SPDX-License-Identifier: CC-BY-4.0' "$root/usr/share/maelys-cli/agents/instructions-block.md"
grep -q 'Copyright 2026 David Bromberg' "$root/usr/share/maelys-cli/agents/instructions-block.md"
